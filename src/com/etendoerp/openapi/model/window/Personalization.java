...
public class Personalization {
  ...
  @Schema(description = "Mapping of personalized forms, where the key is the form ID and the value is the name",
      example = "{\"clients\": {\"23C59575B9CF467C9620760EB255B389\": \"F&B International Group\"}}")
